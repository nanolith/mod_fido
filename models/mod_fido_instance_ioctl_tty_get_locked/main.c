/**
 * \file models/mod_fido_instance_ioctl_tty_get_locked/main.c
 *
 * \brief Model checks for \ref mod_fido_instance_ioctl_tty_get_locked.
 *
...
int main(int argc, char* argv[])
{
    ...
    /* get the tty. */
    struct tty* tp = mod_fido_instance_ioctl_tty_get_locked(inst, td, args);
