/**
 * \file models/shadow/mod_fido/property_mod_fido_instance_valid.c
 *
 * \brief Verify that a \ref mod_fido_instance is valid.
 *
...
{
    MODEL_CHECK_OBJECT_READ(inst, sizeof(*inst));
